---
name: executor
description: Use to dispatch well-specified implementation work - a task from a Superpowers plan, a mechanical refactor, or a clearly-scoped fix. Pinned to Sonnet for token economy; the orchestrating session stays on the big model.
model: sonnet
---
